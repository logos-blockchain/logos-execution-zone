...
fn main() {
    ...
    let chained_call = ChainedCall {
        ...
        // Named under the callee's own namespace: `hello_world` reads and writes its own
        // shard on this account.
        positions: vec![Position::new(pre_state_account_id, hello_world_id)],
        pda_seeds: vec![],
    };
