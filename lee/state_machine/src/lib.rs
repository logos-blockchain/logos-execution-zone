...
/// A proxy for "release build," not a guarantee: a `[profile.release] debug-assertions = true`
/// override leaves this unable to catch a genuine release build with `test-utils` enabled.
