...
pub mod tests {
    ...
    pub fn message_for_tests() -> Message {
        ...
        let apk1 = lee_core::AuthorizationPublicKey::from(&[9; 32]);
        let apk2 = lee_core::AuthorizationPublicKey::from(&[10; 32]);
        ...
        let account_id2 =
            lee_core::account::AccountId::for_regular_private_account(&npk2, &apk2, &vpk, 0);
        let new_commitments = vec![Commitment::new(&account_id2, &account2)];

        let account_id1 =
            lee_core::account::AccountId::for_regular_private_account(&npk1, &apk1, &vpk, 0);
    ...
    fn encrypted_account_data_constructor() {
        ...
        let apk = lee_core::AuthorizationPublicKey::from(&[4; 32]);
        let vpk = ViewingPublicKey::from_seed(&[2_u8; 32], &[3_u8; 32]);
        let account = Account::default();
        let account_id =
            lee_core::account::AccountId::for_regular_private_account(&npk, &apk, &vpk, 0);
