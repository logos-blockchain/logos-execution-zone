...
impl GroupKeyHolder {
    ...
    pub fn derive_regular_shared_account_keys_from_identifier(
        ...
        let mut hasher = sha2::Sha256::new();
        hasher.update(PREFIX);
        hasher.update(lee_core::identifier_to_le_bytes(identifier));
...
mod tests {
    ...
    fn pinned_end_to_end_derivation_for_private_pda() {
        ...
        let account_id = AccountId::for_private_pda(&program_id, &seed, &npk, &vpk, (u128::MAX, u128::MAX));
        ...
        let expected_account_id =
            AccountId::for_private_pda(&program_id, &seed, &expected_npk, &vpk, (u128::MAX, u128::MAX));
    ...
    fn group_pda_lifecycle() {
        ...
        let alice_account_id =
            AccountId::for_private_pda(&program_id, &pda_seed, &alice_npk, &alice_vpk, (0, 0));
        let bob_account_id =
            AccountId::for_private_pda(&program_id, &pda_seed, &bob_npk, &bob_group_vpk, (0, 0));
