...
mod tests {
    ...
    fn cleanup() {
        ...
        acc.value
            .1
            .insert(PrivateAccountKind::Regular(Identifier::from_parts(0, 0)), lee::Account::funded(2));
        ...
        acc.value
            .1
            .insert(PrivateAccountKind::Regular(Identifier::from_parts(0, 0)), lee::Account::funded(3));
        ...
        acc.value
            .1
            .insert(PrivateAccountKind::Regular(Identifier::from_parts(0, 0)), lee::Account::funded(5));
        ...
        acc.value
            .1
            .insert(PrivateAccountKind::Regular(Identifier::from_parts(0, 0)), lee::Account::funded(6));
        ...
        assert_eq!(
            acc.value.1[&PrivateAccountKind::Regular(Identifier::from_parts(0, 0))]
                .data
                .balance()
                .unwrap(),
            2
