...
impl CliAccountMention {
    ...
    #[must_use]
    pub fn into_public_identity(self, account_id: lee::AccountId, sign: bool) -> crate::Identity {
        match self {
            Self::KeyPath(key_path) => crate::Identity::PublicKeycard {
                account_id,
                key_path,
            },
            Self::Id(_) | Self::Label(_) if sign => crate::Identity::Public(account_id),
            Self::Id(_) | Self::Label(_) => crate::Identity::PublicNoSign(account_id),
        }
    }
}
