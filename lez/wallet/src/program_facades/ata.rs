    ...
    pub async fn send_create(
        ...
        self.0
            .send_pub_tx(
                vec![
                    owner.balance_only(),
                    AccountIdentity::PublicNoSign(definition_id).in_namespace(token_program_id),
                    AccountIdentity::PublicNoSign(ata_id).in_namespace(token_program_id),
                ],
                instruction_data,
                ata_program_id,
            )
    ...
    pub async fn send_transfer(
        ...
        self.0
            .send_pub_tx(
                vec![
                    owner.balance_only(),
                    AccountIdentity::PublicNoSign(sender_ata_id).in_namespace(token_program_id),
                    AccountIdentity::PublicNoSign(recipient_id).in_namespace(token_program_id),
                ],
                instruction_data,
                ata_program_id,
            )
    ...
    pub async fn send_burn(
        ...
        self.0
            .send_pub_tx(
                vec![
                    owner.balance_only(),
                    AccountIdentity::PublicNoSign(holder_ata_id).in_namespace(token_program_id),
                    AccountIdentity::PublicNoSign(definition_id).in_namespace(token_program_id),
                ],
                instruction_data,
                ata_program_id,
    ...
    pub async fn send_create_private_owner(
        ...
        let accounts = vec![
            self.0
                ...
                .ok_or(ExecutionFailureKind::KeyNotFoundError)?
                .balance_only(),
            AccountIdentity::Public(definition_id).in_namespace(token_program_id),
            AccountIdentity::Public(ata_id).in_namespace(token_program_id),
        ];
    ...
    pub async fn send_transfer_private_owner(
        ...
        let accounts = vec![
            self.0
                ...
                .ok_or(ExecutionFailureKind::KeyNotFoundError)?
                .balance_only(),
            AccountIdentity::Public(sender_ata_id).in_namespace(token_program_id),
            AccountIdentity::Public(recipient_id).in_namespace(token_program_id),
        ];
    ...
    pub async fn send_burn_private_owner(
        ...
        let accounts = vec![
            self.0
                ...
                .ok_or(ExecutionFailureKind::KeyNotFoundError)?
                .balance_only(),
            AccountIdentity::Public(holder_ata_id).in_namespace(token_program_id),
            AccountIdentity::Public(definition_id).in_namespace(token_program_id),
        ];
