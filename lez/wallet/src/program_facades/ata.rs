...
/// Creation branches on both. `check_contents` and `check_definition_kind` in
/// `lez/programs/associated_token_account/src/create.rs` re-derive them against live state.
