...
/// The committee arrivals are screened against, as the chain now holds it.
/// Sent from the follow path, which moves whether or not this node produces.
pub struct SetCommittee(pub SequencerStakeConfig);
...
impl Approval {
    ...
    #[must_use]
    pub fn verify(&self, channel_id: [u8; 32]) -> bool {
