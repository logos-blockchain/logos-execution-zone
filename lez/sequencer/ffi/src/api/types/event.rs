use crate::api::types::{FfiBlockId, FfiHashType, FfiProgramId, FfiSelector, vectors::FfiVecU8};
...
// /// - `val` is a pointer to an `FfiVec<FfiEventRecord>` produced by this library and not yet
// freed. #[unsafe(no_mangle)]
