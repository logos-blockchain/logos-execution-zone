...
pub fn new_fungible_definition(
    ...
    let definition_diff = AccountDiff {
    ...
    vec![
        AccountDiffOutput::new_claimed(definition_diff, Claim::Authorized),
...
pub fn new_definition_with_metadata(
    ...
    vec![
        AccountDiffOutput::new_claimed(definition_diff, Claim::Authorized),
        AccountDiffOutput::new_claimed(holding_diff, Claim::Authorized),
        AccountDiffOutput::new_claimed(metadata_diff, Claim::Authorized),
    ]
}
