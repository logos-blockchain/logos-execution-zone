...
///
/// Every account a variant names is positioned under this program's own namespace: the
/// definitions, holdings and metadata are all records this program writes.
