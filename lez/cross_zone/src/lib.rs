...
pub fn is_sequencer_only_program(account_id: AccountId) -> bool {
    account_id == loader_core::immutable_deploy_account_id(programs::cross_zone_inbox().id())
}
...
pub fn extract_emission(account_id: AccountId, instruction_data: &[u32]) -> Option<Emission> {
    if account_id == loader_core::immutable_deploy_account_id(programs::ping_sender().id()) {
    ...
    } else if account_id == loader_core::immutable_deploy_account_id(programs::bridge_lock().id()) {
...
fn build_inbox_dispatch_tx(
    ...
    let inbox_account_id = loader_core::immutable_deploy_account_id(inbox_id);
...
pub fn build_dispatch_from_emission(
    ...
    let msg = CrossZoneMessage {
        ...
        target_program_id,
        target_account_id: loader_core::immutable_deploy_account_id(target_program_id),
        payload,
            ...
            cross_zone
                ...
                .flat_map(|peer| {
                    peer.allowed_routes
                        ...
                        .map(|route| (peer.channel_id, route.src_account_id))
                })
                .collect()
        })
        .unwrap_or_default();
...
pub fn build_ping_sender_init_config_tx() -> lee::PublicTransaction {
    ...
    genesis_public_tx(
        ...
        ping_core::SenderInstruction::InitConfig {
            ...
            outbox_account_id: loader_core::immutable_deploy_account_id(outbox_id),
    ...
    genesis_public_tx(
        ...
        ping_core::ReceiverInstruction::InitConfig {
            ...
            config: ping_core::ReceiverConfig {
                deliverer: loader_core::immutable_deploy_account_id(
...
fn genesis_public_tx<I: Serialize>(
    ...
    let message = lee::public_transaction::Message::try_new(
        loader_core::immutable_deploy_account_id(program_id),
        account_ids,
        vec![],
        instruction,
    )
